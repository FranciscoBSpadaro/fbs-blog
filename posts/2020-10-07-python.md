...
def fibonacci(i, b=0, c=1):  **na definição dessa função o parâmetro i é o numero inteiro que vai ser digitado no input do print b=0 e c=1 igual no exemplo anterior , são os parâmetros base para o calculo de Fibonacci**