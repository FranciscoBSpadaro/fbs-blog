...
**Essa Função Recursiva está um pouco diferente do exemplo anterior , porem segue a mesma lógica** 

def fatorial(n: int) -> int:  **Definição da função Fatorial recebe como parâmetro números inteiros** 

if n == 1 or n == 0:
        return 1      =   **Significa que o numero inteiro do valor do fatorial deve retornar  1 se for digitado 0 ou 1 no input**

return n * fatorial(n - 1)  = **retorna n   1 * vezes o valor do fatorial e o parâmetro ( n - 1 ) retira -1 a cada ciclo para zerar o contador até concluir o calculo**