...
return n * fatorial(n - 1)  = **retorna n  (ex 5 )  *  Fatorial quem tem parâmetro ( n - 1 ) retira -1 a cada ciclo para zerar o contador até concluir o calculo onde n é o numero do fatorial digitado no input**